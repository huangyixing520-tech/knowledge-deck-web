...
export function getConfigStatus() {
  ...
  const analyticsReady = Boolean(process.env.ANALYTICS_SALT || process.env.NEXTAUTH_SECRET);
  ...
  return [
    ...
    },
    {
      ...
      detail: analyticsReady ? "匿名访客、会话、页面和点击会被记录" : "建议配置 ANALYTICS_SALT 或 NEXTAUTH_SECRET"
    },
    {
      key: "nextauth",
      label: "会话安全",
